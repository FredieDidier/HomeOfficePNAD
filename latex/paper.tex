...
\subsection{How the priority could affect labor-market outcomes}\label{sec:framework}
...
The estimation sample is women aged 18--49 who are the household head or the head's spouse or partner---the women for whom the presence of a young child in the household is informative about their own children---and whom the matching procedure links across quarters. The roughly 3.7\% of women who cannot be linked receive singleton identifiers and so contribute nothing under individual fixed effects; excluding them leaves the estimates unchanged. The main outcome is an indicator for working from home, defined as performing the main job at the worker's own residence. The remaining outcomes are real monthly labor earnings---in constant reais of the first quarter of 2026, the most recent quarter, deflated with IBGE's official PNADC deflator---usual weekly hours, indicators for employment and for labor-force participation (each defined for every woman in the sample, taking the value zero rather than missing for those not employed or not in the labor force, so that the estimates are not conditioned on labor-market status), and an indicator for being on maternity leave, a proxy for a recent birth. All statistics and estimates use the survey's sampling weights.

Treatment is defined by the presence in the household of a child aged 4 or younger, for a woman who is head or spouse. The primary comparison group is women whose youngest child is aged 5--7: mothers who are similar on the margins that select women into motherhood but whose youngest child has just crossed the statutory age cutoff. A broader comparison group, women with no child aged 0--7, is used to gauge precision and to build a placebo. An occupation is classified as telework-eligible following the adaptation of \citet{dingelneiman2020} to Brazilian occupation codes by \citet{goes2020} and \citet{costa2024}, described in Appendix~\ref{app:telework}; it enters only as a moderator and as an outcome in the mechanism analysis, never as a sample restriction, since occupation may itself respond to the reform.
...
Table~\ref{tab:heterogeneity} reports the first-stage effect across subgroups, all defined at baseline, and Appendix Figure~\ref{fig:hetero} summarizes the same estimates visually. The splits by contract type are the most informative, because the statute binds only on registered private-sector employees: if the estimate reflected Article 75-F rather than a generic shock to mothers of young children, it should appear for that group and vanish for informal and public-sector workers. Instead it is indistinguishable from zero everywhere: for formal and informal workers, for registered private-sector employees and for public employees, and across education and age. Of the 11 subgroups only one, women aged 40 to 49, is individually significant, and this is what testing many subgroups produces by chance: the cell is small and selected, and no theory singles it out. Correcting for the number of tests \citep{romanoshaikhwolf2010} with a conservative Bonferroni adjustment across the 11 subgroups confirms as much---nothing remains significant, the smallest $p$-value ($0.04$, for women aged 40 to 49) rising to $0.47$. Nor does that cell show any downstream response: estimating the full set of outcomes for it, only home office is significant, while earnings, hours, employment, participation, and maternity leave are all indistinguishable from zero, so the isolated first-stage coefficient leaves no trace in the outcomes it would have to work through. The heterogeneity analysis thus does not rescue a hidden effect; it shows the null is uniform, including where the law was supposed to bite hardest.
...
The central finding is a precisely estimated null: a legal priority to telework for mothers of young children did not raise their telework take-up, and produced no detectable change in occupational sorting or labor-market outcomes. Of the two cases set out in Section~\ref{sec:framework}, the evidence points squarely to the second, in which the priority does not bind. A priority is only as valuable as the stock of teleworkable positions an employer has to allocate, and for most eligible women that stock is close to empty: the statute reaches only registered private-sector employees under the CLT, yet a large share of Brazilian women work informally or outside formal employment, and among the formally employed only a minority hold jobs that can plausibly be performed from home. Home office is correspondingly rare---about 5\% of employed women in the sample---so even a mandate that bound perfectly among the teleworkable would move the population average little. Consistent with this, the effect is no larger among women already in telework-eligible occupations, the subgroup for whom a priority in allocating such positions is not vacuous, and eligible mothers did not move toward those occupations to claim the benefit.
