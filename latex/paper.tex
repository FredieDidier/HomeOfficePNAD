...
The estimation sample is women aged 18--49 who are the household head or the head's spouse or partner---the women for whom the presence of a young child in the household is informative about their own children---and whom the matching procedure links across quarters. The roughly 3.7\% of women who cannot be linked receive singleton identifiers and so contribute nothing under individual fixed effects; excluding them leaves the estimates unchanged. The main outcome is an indicator for working from home, defined as performing the main job at the worker's own residence. The remaining outcomes are real monthly labor earnings, usual weekly hours, indicators for employment and for labor-force participation---each defined for every woman in the sample, taking the value zero (not missing) for those not employed or not in the labor force, so that the estimates are not conditioned on labor-market status---and an indicator for being on maternity leave, a proxy for a recent birth. All statistics and estimates use the survey's sampling weights.
...
Table~\ref{tab:descriptives} reports summary statistics by group and period, and two patterns stand out. Working from home is uncommon in every group---about 5\% before the reform---and rises only modestly afterward, in parallel across groups; Figure~\ref{fig:trends} shows this quarter by quarter. Treated women are younger, participate less in the labor market, and are less likely to hold a formal job than the comparison groups, precisely the selection that the individual fixed effects are designed to absorb.
