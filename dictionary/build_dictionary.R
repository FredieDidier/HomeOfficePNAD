...
dict <- data.frame(stringsAsFactors = FALSE,
                   ...
                   source = c(
                     "datazoom.social", "datazoom.social", "Project-derived", "Project-derived",
                   ...
                   description_pt = c(
                     ...
                     "Identificador do domicílio. Único dentro de cada grupo de rotação V1014.",
                     ...
                     "Posição na ocupação no trabalho principal (1=empregado com carteira privado, 2=empregado sem carteira privado, 3=empregado com carteira público, 4=empregado sem carteira público, 5=militar e servidor estatutário, 6=sem carteira doméstico, 7=com carteira doméstico, 8=empregador, 9=conta própria, 10=trabalhador familiar auxiliar)",
                     "Indicador de ocupação (=1 se VD4002==1)",
                     "Indicador de participação na força de trabalho (=1 se VD4001==1)",
                     "Emprego formal (com carteira assinada, servidor público ou militar)",
                     "Emprego informal (sem carteira, conta própria sem contribuição)",
                     ...
                     "Local de trabalho (1=estabelecimento do empregador, 2=estabelecimento de cliente/terceiro, 3=veículo, 4=domicílio próprio com local fixo, 5=domicílio próprio sem local fixo, 6=área externa/logradouro). Disponível a partir de 2018T1.",
                   ...
                   description_en = c(
                     ...
                     "Household identifier. Unique within each V1014 panel rotation group.",
                     ...
                     "Position in main job (1=private employee with formal contract, 2=private employee without formal contract, 3=public employee with formal contract, 4=public employee without formal contract, 5=military/civil servant, 6=domestic worker without contract, 7=domestic worker with contract, 8=employer, 9=self-employed, 10=unpaid family worker)",
                     "Employed indicator (=1 if VD4002==1)",
                     "Labor force participation indicator (=1 if VD4001==1)",
                     "Formal employment (signed labor card, civil servant, or military)",
                     "Informal employment (no contract, self-employed without social security contribution)",
                     ...
                     "Work location (1=employer premises, 2=client/other premises, 3=vehicle, 4=own home with dedicated workspace, 5=own home without dedicated workspace, 6=outdoors/street). Available from Q1 2018.",
                   ...
                   values_notes = c(
                     ...
                     "Integer. Unique within V1014 group.",
