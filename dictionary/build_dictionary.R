...
dict <- data.frame(stringsAsFactors = FALSE,
                   ...
                   source = c(
                     ...
                     "Project-derived",
                     "Project-derived", "Project-derived", "Project-derived", "Project-derived",
                     "Project-derived", "Project-derived", "Project-derived", "Project-derived",
                     "Project-derived", "Project-derived", "Project-derived", "Project-derived",
                     "Project-derived",
                     "Project-derived",
                   ...
                   description_pt = c(
                     ...
                     "=1 se is_head_or_spouse==1 e há criança ≤4 anos no domicílio, excluindo netos(as)/bisnetos(as) E enteados(as) (V2005 ∈ {10,11,6}). Inclui apenas filhos(as) biológicos/adotivos do responsável e/ou cônjuge (V2005=4,5). Versão de robustez.",
                     ...
                     "=1 se is_head_or_spouse==1 e há criança de 5 a 7 anos no domicílio, excluindo netos(as)/bisnetos(as) E enteados(as) (V2005 ∈ {4,5} apenas). Versão de robustez do Controle A.",
                     ...
                     "Idade da criança mais nova ≤4 anos no domicílio, excluindo netos/bisnetos E enteados (NA se has_child_u4_no_gc_sc==0)",
                   ...
                   description_en = c(
                     ...
                     "Habitual earnings deflator (IBGE, quarterly base)",
                     ...
                     "=1 if is_head_or_spouse==1 and household has a child aged ≤4, excluding both grandchildren/great-grandchildren AND stepchildren (V2005 ∈ {10,11,6}). Includes only biological children of head and/or spouse (V2005=4,5). Robustness version.",
                     ...
                     "=1 if is_head_or_spouse==1 and household has a child aged 5–7, excluding both grandchildren/great-grandchildren and stepchildren (V2005 ∈ {4,5} only). Robustness version of Control A.",
                     ...
                     "Age of youngest child aged ≤4, excluding both grandchildren/great-grandchildren and stepchildren (NA if has_child_u4_no_gc_sc==0)",
                     ...
                     "=1 if VD4009==1 (private-sector employee with a signed card = private CLT employee). NOTE: superseded by clt_covered (VD4009 ∈ {1,5}, which adds public-sector celetistas) as the covered group. clt_private is derived in the build but is not used in the current analysis, which uses clt_covered throughout. =0 otherwise, including the non-employed.",
                   ...
                   values_notes = c(
                     ...
                     "2018–2026",
                     "1, 2, 3, 4",
                     "E.g. 20181 (Q1 2018) through 20261 (Q1 2026)",
                     ...
                     "6–13 in this dataset (2018–2026)",
                     ...
                     "1–19. Key values for this project: 1 (head), 2–3 (spouse), 4–6 (child/stepchild), 10–11 (grandchild/great-grandchild).",
                     "1 or 2",
                     ...
                     "Real number between 0 and 1. Multiply by VD4019 to get real earnings.",
                     "Positive real or NA. Main earnings variable for analysis.",
                     "Positive real or NA (if not employed or not in scope)",
                     "Positive real or NA",
                     ...
                     "0 or 1 (integer). Robustness: V2005 ∈ {4,5}, age ≤4. Excludes both grandchildren/great-grandchildren and stepchildren.",
                     ...
                     "0 or 1 (integer). Robustness Control A: V2005 ∈ {4,5}, age 5–7. Excludes both grandchildren/great-grandchildren and stepchildren.",
                     "0–4 (integer) or NA",
                     "0–4 (integer) or NA",
                     "0–4 (integer) or NA",
                     "0–4 (integer) or NA",
                     ...
                     "0 or 1 (integer). Private-only CLT (carteira) indicator, VD4009==1. Narrower private-only definition, superseded by clt_covered and not used in the current analysis; see clt_covered for the full covered group (private + public celetistas). ~19.5% of sample women, ~34% of employed.",
                     ...
                     "0 or 1 (integer). Covered-CLT indicator, VD4009 ∈ {1,5} (private + public celetistas). Headline 'legally covered' group for Art. 75-F; public celetistas ≈4.8% of the covered pool among treated women. clt_private (VD4009==1) is the narrower private-only definition, not used in the current analysis."
                   )
)
