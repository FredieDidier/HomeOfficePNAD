...
\begin{table}[htbp]
   ...
   \par \raggedright 
   Each column is a triple-difference regression (spec of Table \ref{tab:triple\_diff}). Reported: the men effect (Treated $\times$ Post) and the female differential (Treated $\times$ Post $\times$ Female). $^{*}$/$^{**}$/$^{***}$: 10/5/1\%.
\end{table}
